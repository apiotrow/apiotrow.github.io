...
Stupid me. Thought maybe they had spherical gravity implemented, and I could just steal it. Turns out no. It's just a globe with buildings. But then I thought maybe they had some super secret way of wrapping things around the face of a sphere. Wrong again. They either hand-crafted those building to sit on the sphere like that, or they did some kind of wrapping in a 3D modeling program and imported them as a unit. Out of anger, hurt, and resentment, I started the planet thing I described above. And look how fucking well that turned out. No thanks to you, you fucking ingrate.

I did notice that they have bloom and lens flares, depth of field, and antialiasing on their main camera, though, which gives it that cool blur effect. I think I'm going to mess with that next. I'm getting kind of tired of Alice anyway. She was fun for a while, but we've been moving in different directions lately. Plus she has a bad habit of falling through the terrain when her capsule collider increases in size and clips through the mesh.